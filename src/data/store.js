...
let projects = [
  {
    id: 1,
    name: `May's Sweets & Treats System Design`,
    description: 'Website Deployment and Infrastructure design ',
    created_at: seededAt,
    updated_at: seededAt,
  },
  {
    id: 2,
    name: 'The Lawn Ranger Design Application',
    description: 'Business Website Deployment',
    created_at: seededAt,
    updated_at: seededAt,
  },
]
...
let tasks = [
  ...
  },
  {
    id: 2,
    project_id: 2,
    title: 'Wireframe Design and Prototyping',
    description: `Design of low-fidelity wireframes to establish the application's layout, navigation, and user experience, providing a visual blueprint for future development.`,
    status: 'in_progress',
    created_at: seededAt,
    updated_at: seededAt,
  },
  {
    id: 3,
    project_id: 2,
    title: 'User Interface Design (High-Fidelity)',
    description: 'Creation of high-fidelity designs to define visual elements such as colors, typography, and components prior to development.',
    status: 'pending',
    created_at: seededAt,
    updated_at: seededAt,
  },
